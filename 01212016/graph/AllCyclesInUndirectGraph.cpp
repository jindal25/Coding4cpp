...
We have also discussed a union-find algorithm for cycle detection in undirected graphs.
 ...
 we say that there is no cycle. The assumption of this approach is that there are no parallel 
...
bool Graph::isCyclicUtil(int v, bool visited[], int parent)
{
    ...
    {
        cout << "adj list for v is " << *i << " visited " << visited[*i] << endl;
